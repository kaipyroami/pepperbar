...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.pepperbar.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".pepperbar" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".pepperbar")
	}
